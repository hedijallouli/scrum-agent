...
log_info "Total PR diff: ${TOTAL_DIFF} lines (limit: 300)"
if (( TOTAL_DIFF > 300 )); then
  add_issue "PR_TOO_LARGE: PR has ${TOTAL_DIFF} lines changed. Hard limit is 300 lines. Split into smaller PRs."
  CHECKS_PASSED=false
fi
