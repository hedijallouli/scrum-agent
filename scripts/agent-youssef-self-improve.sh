...
# Usage: agent-youssef-self-improve.sh BISB-XX
# =============================================================================
AGENT_NAME="youssef"
set -euo pipefail
...
TICKET_KEY="${1:?Usage: agent-youssef-self-improve.sh BISB-XX}"
MAX_RETRIES=2
...
VPS_SCRIPT_PATH="/opt/bisb-scripts/${TARGET_SCRIPT}"
...
CLAUDE_PROMPT="You are Youssef, the Dev agent for the BisB AI squad.
...
- [ ] Test manuel sur VPS (\`/opt/bisb-scripts/${TARGET_SCRIPT}\`)
