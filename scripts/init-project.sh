...
# Deploy this to VPS at /etc/${PROJECT_PREFIX}/.env.agents (or project-specific path)
# =============================================================================
...
echo "     scp ${ENV_FILE} root@49.13.225.201:/etc/${PROJECT_PREFIX}/.env.agents.${KEY_LOWER}"
